<template>
    <div>
        <h1>为什么叫『Coolers』</h1>
        <p>『Coolers』，是『冷却剂』的意思，如今的社会充满浮躁和快节奏，我们希望可以适当的冷却自己，在冷静的思考下作出正确的决定，不随波逐流；同时在英语中有个『语法糖』——职业或者人一般会加『er』等其他后缀，所以我们希望集结一些Cool
            Guys，一些很酷的技术宅，当然，『Coolers』在英语里面是没有『酷酷的人』的意思的，这也仅是我赋予的特殊含义。</p>
        <h1>『Coolers』将面向谁服务</h1>
        <p>『Coolers』，将面向无数企业和各地的学生代表，为他们提供前后端、人工智能等方面的解决方案，也将招募全国各地的优秀开发者。</p>
        <h1>『Coolers』的愿景</h1>
        ...
        <p>『Coolers』的主要技术栈是Vue.js，同时我们也会使用一些其他的技术，比如Node.js、Python、Java等。<br />
            <a href="https://developer.android.com" target="_blank" rel="noreferrer"> <img
                ...
                rel="noreferrer"> <img src="https://www.vectorlogo.zone/logos/git-scm/git-scm-icon.svg" alt="git"
                    ...
                    src="https://www.vectorlogo.zone/logos/hexoio/hexoio-icon.svg" alt="hexo" width="40" height="40" />
            </a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target="_blank" rel="noreferrer"> <img
                ...
                rel="noreferrer"> <img src="https://upload.wikimedia.org/wikipedia/commons/2/21/Matlab_Logo.png"
                    alt="matlab" width="40" height="40" /> </a> <a href="https://www.mysql.com/" target="_blank"
                rel="noreferrer"> <img
        ...
        <h1>『Coolers』的未来</h1>
        <p>『Coolers』的未来是无限的，我们将会不断的招募优秀的开发者，不断的开发出更多的优秀的产品，不断的为更多的企业和学生代表提供优秀的服务。</p>
    </div>
</template>
